...
/* JSX : 하나의 파일 안에 HTMl 문법과 JS문법을 동시에 작성 
    ...
    JSX 는 확장자가 기본적으로 .jsx이지만, .js로 사용도 가능하다.

    [JSX의 특징]
    1. 여러 요소가 있다면 반드시 하나의 부모요소로 감싸 줄 것
      이 때, 꼭 div태그가 아니여도 가능(다른태그 O, <></>)

    2. 표현식 사용
      - 만약, return문 안에서 JS 문법을 사용하려면 {} 작성
    ...
    4. 스타일링 적용
      ...
      4.2.) css 형태로 삽입
        ...
        - import 를 통해 css 파일을 가져온다.
    
    5. 그 외 기존 문법과 다른 점
      - 태그를 사용할 때 무조건 소문자만 사용
        ex) <Div></Div> (X) <di></di> (O)
      - 끝 태그 생략 불가
        ex) <br><br/> => <br/> => <br> 생략 가능
          React : <br><br/> => <br/>
*/
